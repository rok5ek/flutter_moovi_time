...
class GetMoviesPopular extends UseCase<AppResult<List<MovieEntity>, AppError>, NoParams> {
  final AppRepository repository;

  GetMoviesPopular({required this.repository});

  @override
  Future<AppResult<List<MovieEntity>, AppError>> call(NoParams params) async {
    return await repository.getMoviesPopular(cancelToken);
  }
